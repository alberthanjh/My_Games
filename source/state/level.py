...
def generate_newlevel():
    ...
    for dictory in js["zombie_list"]:#遍历僵尸列表
        ...
        k+=1
    js2=json.dumps(js)
    with open("D:\\PythonPlantsVsZombies-master\\source\\data\\map\\level_6.json","w") as f:
        f.write(js2)

    l.remove(i)
    return "D:\\PythonPlantsVsZombies-master\\source\\data\\map\\level_6.json"
